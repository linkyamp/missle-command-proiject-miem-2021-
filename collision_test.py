...
class TestPuli(unittest.TestCase):
    def test_puli(self):
        self.assertEqual([Rect1, Rect2, random.randint(100, 1000), random.randint(100, 1000)], 1)
    def test_promah(self):
        self.assertEqual([Rect1, Rect3, random.randint(100, 1000), random.randint(100, 1000)], 0)
